...
<section class="container create-pin">
    <p class="wave-title">
        <?= Yii::t('yacht', 'Create Profile for a CREWED CHARTER BOAT') ?>
    </p>
    ...
    <div class="js-crew-form">
        <?php
        foreach ($crewMembers as $crewMember) {

            echo $this->render('//yacht/_ajax_crew', [
                'model' => $model,
    ...
    <div class="text-center">
        <a href="#" class="js-add-crew blue-btn">
            <?= \Yii::t('yacht', '+ Add Crew') ?>
        </a>
    </div>


    <div class="js-crew_description" style="<?php echo empty($crewMembers) ? 'display: none' : ''; ?>">
        <?= $form->field($model, 'crew_description')->textArea(['class' => 'form-control', 'rows' => "5", 'placeholder' => \Yii::t('yacht', 'Please give us a short summary about your crew and the experience provided on board.')])->label(false) ?>
    </div>
    <div class="row">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="page-preview blue">
                        ...
                        <div class="js-season-form">
                            <?php
                            foreach ($yachtSeasons as $yachtSeason) {

                                echo $this->render('//yacht/_ajax_season', [
                                    'model' => $model,
                        ...
                        <a href="#" class="js-add-season add-email">
                            <?= \Yii::t('yacht', '+ Add Season and Cruising Grounds') ?>
                        </a>
